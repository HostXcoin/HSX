...
This mechanism has been integrated into Bitcore-Node-HostxCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/HostxCoin-Project/insight-api-hostxcoin#web-socket-api](https://github.com/HostxCoin-Project/insight-api-hostxcoin#web-socket-api) 
* API: [https://github.com/HostxCoin-Project/insight-api-hostxcoin#swifttx-transactions](https://github.com/HostxCoin-Project/insight-api-hostxcoin#swifttx-transactions) 
...
By default, the HostxCoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the HostxCoin daemon:
