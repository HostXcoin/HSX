...
In order to support loading of multiple wallets in hostxcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hostxcoin.cpp.
...
Changes to hostxcoin.cpp
----------------------
hostxcoin.cpp is the entry point into hostxcoin-qt, and as such, will require some minor modifications to provide hooks for
