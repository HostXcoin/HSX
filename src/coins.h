...
/** 
    ...
    ****Note - for HostxCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of hostxcoin coming in to a transaction
