...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HostxCoin hostxcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hostxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hostxcoin transaction") + "\n" +
                               "  hostxcoin-tx [options] -create [commands]   " + _("Create hex-encoded hostxcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hostxcoin transaction
