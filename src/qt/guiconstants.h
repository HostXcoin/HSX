...
/* HostxCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HostxCoin"
#define QAPP_ORG_DOMAIN "hostxcoin.online"
#define QAPP_APP_NAME_DEFAULT "HostxCoin-Qt"
#define QAPP_APP_NAME_TESTNET "HostxCoin-Qt-testnet"
