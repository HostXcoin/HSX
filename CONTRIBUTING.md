Contributing to HostxCoin
============================

The HostxCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the HostxCoin project, and is not to be
confused with overall HostxCoin Network Protocol consensus changes.

Whether a pull request is merged into HostxCoin rests with the project merge
...
Patches that change HostxCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the HostxCoin consensus, it must have been
...
The project leader is the release manager for each HostxCoin release.
