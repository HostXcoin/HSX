...
#   c) node1 mines 32 blocks, so now node 0 has 60001HSX, node 1 has 4250HSX, node2 has none.
#   d) node0 sends 601 HSX to node2, in two transactions (301 HSX, then 300 HSX).
