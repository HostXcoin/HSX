...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/hostxcoin-cli.cpp \
           src/hostxcoin-tx.cpp \
           src/hostxcoin.cpp \
           src/db.cpp \
           ...
           src/qt/hostxcoin.cpp \
           src/qt/hostxcoinstrings.cpp \
...
RESOURCES += src/qt/hostxcoin.qrc src/qt/hostxcoin_locale.qrc

TRANSLATIONS += src/qt/locale/hostxcoin_bg.ts \
                src/qt/locale/hostxcoin_de.ts \
                src/qt/locale/hostxcoin_en.ts \
                src/qt/locale/hostxcoin_es.ts \
                src/qt/locale/hostxcoin_fi.ts \
                src/qt/locale/hostxcoin_fr.ts \
                src/qt/locale/hostxcoin_it.ts \
                src/qt/locale/hostxcoin_ja.ts \
                src/qt/locale/hostxcoin_pl.ts \
                src/qt/locale/hostxcoin_pt.ts \
                src/qt/locale/hostxcoin_ru.ts \
                src/qt/locale/hostxcoin_sk.ts \
                src/qt/locale/hostxcoin_sv.ts \
                src/qt/locale/hostxcoin_vi.ts \
                src/qt/locale/hostxcoin_zh_CN.ts \
                src/qt/locale/hostxcoin_zh_TW.ts
